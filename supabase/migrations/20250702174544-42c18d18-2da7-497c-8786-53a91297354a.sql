...
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_user_roles_user_role ON public.user_roles(user_id, role);
CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_theses_status_created ON public.theses(status, created_at);
