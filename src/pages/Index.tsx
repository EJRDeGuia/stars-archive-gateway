...
const Index = () => {
  ...
  return <div className="min-h-screen relative overflow-hidden">
      {/* Enhanced Background with Tile Texture and Blur */}
      <div className="fixed inset-0 z-0">
        ...
        {/* Green tint overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-green-900/20 to-green-700/30 mix-blend-soft-light"></div>
