  ...
  return (
    <div className="min-h-screen flex flex-col relative">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url(/lovable-uploads/caa8dcf2-f06e-452b-823a-acc2b65b1d4b.png)`,
                        ...
                        <ul className="grid gap-3 p-6 w-[400px] md:w-[500px] lg:w-[600px]">
                          <li className="row-span-3">
                            <NavigationMenuLink asChild>
                              <a className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-dlsl-green/20 to-dlsl-green/50 p-6 no-underline outline-none focus:shadow-md" href="#">
                  ...
                  return <Card key={college.name} className={`overflow-hidden border-t-4 ${colors.border} hover:shadow-lg transition-all ${colors.hover} cursor-pointer`} onClick={() => navigate(`/college/${college.id}`)}>
                        <CardContent className="p-6">
                          ...
                          <div className="flex justify-between items-center mt-4">
                            <Button variant="link" className={`${colors.text} pl-0 hover:underline`}>
                              Explore theses
                            </Button>
