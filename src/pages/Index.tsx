          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-20">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="inline-flex items-center backdrop-blur-sm px-4 py-2 rounded-full text-sm font-medium border border-white/20 shadow-lg bg-zinc-50">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button size="lg" variant="outline" onClick={() => navigate('/login')} className="border-white hover:bg-white border-2 text-dlsl-green">
              ...
              <div className="hidden md:flex justify-center">
                <div className="relative backdrop-blur-sm">
                  <div className="w-80 h-80 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-white/20 shadow-2xl bg-[dlsl-green-dark] bg-dlsl-green">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {['Intelligent search and categorization', 'Role-based access control', 'Research analytics and insights', 'Department-specific organization', 'Secure cloud storage', 'Collaborative tools'].map((feature, index) => <div key={index} className="flex items-start">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="space-y-6">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <Button size="lg" variant="outline" className="border-white hover:bg-white border-2 text-dlsl-green">
                  <Book className="mr-2 h-5 w-5" />
                  Learn More
                </Button>
              </div>
