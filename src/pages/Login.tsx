  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative z-30 flex flex-col min-h-screen">
        {/* Header */}
        <header className="glass-effect border-b border-white/20 relative z-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-20">
              <div className="flex items-center space-x-4">
                <div className="w-12 h-12 bg-gradient-to-br from-dlsl-green to-dlsl-green-dark rounded-2xl flex items-center justify-center sleek-shadow-xl">
              ...
              <Button 
                onClick={() => navigate('/')} 
                variant="ghost" 
                className="text-gray-700 hover:text-gray-900 backdrop-blur-sm sleek-shadow hover:sleek-shadow-lg transition-all duration-300"
              >
        ...
        <div className="flex-1 flex items-center justify-center p-6 animate-fade-in">
          <Card className="w-full max-w-lg glass-effect border-white/20 sleek-shadow-xl">
            <CardContent className="p-10">
              <div className="flex flex-col items-center mb-10">
                ...
                <div className="w-20 h-20 bg-gradient-to-br from-dlsl-green/10 to-dlsl-green-dark/20 rounded-3xl flex items-center justify-center mb-6 sleek-shadow-xl">
              ...
              <div className="space-y-4 mb-6">
                <Button variant="outline" className="w-full flex items-center justify-center h-14 border-gray-200 hover:border-dlsl-green/30 transition-all duration-300 sleek-shadow hover:sleek-shadow-lg bg-white/80 backdrop-blur-sm" type="button">
              ...
              {/* Demo Credentials */}
              <div className="mt-8 p-6 glass-effect rounded-2xl border border-white/20 sleek-shadow-lg">
