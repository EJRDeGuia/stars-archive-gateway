        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-8">
                  <div className="mb-8">
                    ...
                    <div className="flex items-center gap-6 text-green-600 mb-6">
                    ...
                    <div className="flex items-center gap-8 text-green-500">
                      <div className="flex items-center gap-2">
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-8">
                  <h2 className="text-2xl font-bold text-green-900 mb-6">Abstract</h2>
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-8">
                  <h2 className="text-2xl font-bold text-green-900 mb-6">Research Methodology</h2>
                  <p className="text-green-700 leading-relaxed text-lg">
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-8">
                  <h2 className="text-2xl font-bold text-green-900 mb-6">Key Findings</h2>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-6">
                  <h3 className="text-xl font-bold text-green-900 mb-6">Actions</h3>
                  <div className="space-y-4">
                    <Button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white rounded-xl py-3">
                      <Download className="mr-2 h-5 w-5" />
                      Download PDF
                    </Button>
                    <Button variant="outline" className="w-full border-green-300 text-green-700 hover:bg-green-50 rounded-xl py-3">
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-6">
                  <h3 className="text-xl font-bold text-green-900 mb-6">Document Information</h3>
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-6">
                  <h3 className="text-xl font-bold text-green-900 mb-6">Community Rating</h3>
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-1 mb-4">
                      {[...Array(5)].map((_, i) => (
                        <Star key={i} className={`w-6 h-6 ${i < 4 ? 'text-yellow-400 fill-current' : 'text-green-300'}`} />
                      ))}
                    </div>
                    <div className="text-3xl font-bold text-green-900 mb-2">4.2</div>
                    <div className="text-green-600">Based on 28 reviews</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-green-100 rounded-3xl shadow-sm">
                <div className="p-6">
                  <h3 className="text-xl font-bold text-green-900 mb-6">Related Theses</h3>
                  <div className="space-y-4">
                    {theses.filter(t => t.id !== thesis.id && t.college === thesis.college).slice(0, 3).map((relatedThesis) => (
                      ...
                      >
                        <h4 className="font-medium text-green-900 group-hover:text-green-700 transition-colors leading-tight mb-2">
                          {relatedThesis.title.substring(0, 60)}...
                        </h4>
                        <p className="text-sm text-green-600">{relatedThesis.author} • {relatedThesis.year}</p>
                      </div>
                    ))}
                  </div>
                </div>
