...
import { Search, Filter, Download, RefreshCw, Play, ArrowLeft, Shield, Zap } from "lucide-react";
...
import { MaxSecurityDashboard } from "@/components/security/MaxSecurityDashboard";
            ...
            <div className="mb-8">
              ...
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-xl text-gray-600">Maximum effectiveness security monitoring & enforcement</p>
                </div>
              </div>
            </div>

            {/* Security Monitoring Tabs */}
            <Tabs defaultValue="max-security" className="w-full">
              <TabsList className="grid w-full grid-cols-2 mb-8">
                <TabsTrigger value="max-security" className="flex items-center gap-2">
              ...
              <TabsContent value="max-security" className="space-y-8">
                <MaxSecurityDashboard />
              </TabsContent>
